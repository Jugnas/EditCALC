...
public class Fenetre{
	...
	public void launchPub() {
		...
		ad = new JLabel("");
		ad.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\vachequirit.jpg"));
		...
		this.window.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Sujenth\\Downloads\\faviconEditCALC\\favicon-32x32.png"));
	...
	private JLabel insertDog() {
		dog = new JLabel();
		dog.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\dog.png"));
		return dog;
	}
	...
	public void launchAppli() {
		...
		appli.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\decorCalc.jpg"));
		...
		*/
		...
		gif.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\dog.png"));
		...
		*/
		...
		btnValider.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				//text.setText("");
				if (test) {
					gif.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\genius.gif"));
				}
				else {
					gif.setIcon(new ImageIcon("C:\\Users\\Sujenth\\Pictures\\donald_laugh.gif"));
				}
			}
		});
